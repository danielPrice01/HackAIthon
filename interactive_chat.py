...
class InteractiveChatBot:
    ...
    def __init__(self, env_file="api.env", courses_file="courses/courses.json",
    ...
    def get_filter_instructions(self, user_message):
        ...
        filter_prompt = (
            ...
            "   - 'attribute': one of the following allowed attributes: 'description', 'available', 'cu', 'prereq', 'labels', 'mutually exclusive'.\n"
            ...
            "- For 'description' and 'mutually exclusive', treat the filter value as a generic string filter.\n\n"
    ...
    def public_response(self, filter_summary, original_message):
        public_prompt = (
            ...
            f"Remember, the available filter attributes are: 'description', 'available', 'cu', 'prereq', 'labels', and 'mutually exclusive'. "
