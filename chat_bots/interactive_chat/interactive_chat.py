...
class InteractiveChatBot:
    ...
    def get_filter_instructions(self, user_message):
        ...
        filter_prompt = (
            ...
            "Extract filter instructions in the following way:\n\n"
            ...
            "For 'labels', the value must be one or more of the following allowed labels. Moreover, if any part of the user's input contains a synonym, partial match, or derivative of any allowed label, "
            "you must interpret it as that allowed label. For example, if the user's message contains the word 'database' or 'databases', map it to 'Database Systems'. The full list is:\n"
